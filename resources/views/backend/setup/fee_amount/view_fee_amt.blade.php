                       ...
                       <div class="table-responsive">
                         <table id="example1" class="table table-bordered table-striped">
                           ...
                           <tbody>
                               ...
                               <tr>
                                <td>{{$key + 1}}</td>
                                <td>{{$amt->fee_category_id}}</td>
                                
                    
                                <td>
                                    {{-- id should be used to use sweet alert --}}
                                    <a href="{{route('fee.category.edit',$amt->id)}}" class="btn btn-rounded btn-info mb-5">Edit</a>
                                    <a href="{{route('fee.category.delete',$amt->id)}}" id="delete" class="btn btn-rounded btn-danger mb-5">Delete</a>
                                </td>
                            </tr> 
                               @endforeach
