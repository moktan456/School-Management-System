                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input id="name" type="text" name="fname" class="form-control" required="" >
                                            </div>
                                        </div> 
                                    </div>
                                    {{-- End col-md-4 --}}
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input id="name" type="text" name="mname" class="form-control" required="" >
                                            </div>
                                        </div> 
                                    </div>
                                    {{-- End col-md-4 --}}
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input id="name" type="text" name="mobile" class="form-control" required="" >
                                            </div>
                                        </div> 
                                    </div>
                                    {{-- End col-md-4 --}}
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input id="name" type="text" name="address" class="form-control" required="" >
                                            </div>
                                        </div> 
                                    </div>
                                    {{-- End col-md-4 --}}
