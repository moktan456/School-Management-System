            ...
            <!-- Basic Forms -->
             <div class="box">
               ...
               <div class="box-body">
                 <div class="row">
                   <div class="col">
                       <form novalidate="" action="{{route('emp.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                         <div class="row">
                            <div class="col-12">
                                 {{-- 1st Row --}}
                                 ...
                                 <div class="row">
                                   ...
                                   <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input id="join_date" type="date" name="join_date" class="form-control" required="" >
                                        </div>
                                    </div> 
                                </div>
                                   {{-- End col-md-4 --}}
                           ...
                           <div class="text-xs-right">
                            ...
                            <a href="{{route('emp.view')}}" class="btn btn-rounded btn-warning mb-5">Back</a>
                           </div>
                       </form>
